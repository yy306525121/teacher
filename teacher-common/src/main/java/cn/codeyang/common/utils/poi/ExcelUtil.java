package cn.codeyang.common.utils.poi;

import cn.codeyang.common.annotation.Excel;
import cn.codeyang.common.annotation.Excels;
import cn.codeyang.common.config.RuoYiConfig;
import cn.codeyang.common.core.domain.AjaxResult;
import cn.codeyang.common.core.text.Convert;
import cn.codeyang.common.exception.UtilException;
...
import cn.codeyang.common.utils.file.FileTypeUtils;
import cn.codeyang.common.utils.file.FileUtils;
import cn.codeyang.common.utils.file.ImageUtils;
import cn.codeyang.common.utils.reflect.ReflectUtils;
            ...
            if (!ArrayUtils.contains(this.excludeFields, field.getName())) {
                ...
                if (field.isAnnotationPresent(Excels.class)) {
                    ...
                    for (Excel attr : excels) {
                        if (!ArrayUtils.contains(this.excludeFields, field.getName() + "." + attr.targetAttr()) && (attr != null && (attr.type() == Excel.Type.ALL || attr.type() == type))) {
                            field.setAccessible(true);
                            fields.add(new Object[]{field, attr});
                        }
                    }
